...
export const THEME_FAMILIES: Record<DesignArchetypeId, ThemeFamilyConfig> = {
  modern_tech: {
    ...
    optionalSections: ['rootx-benefits', 'rootx-product-showcase', 'rootx-gallery', 'rootx-comparison', 'rootx-final-cta'],
  ...
  soft_beauty: {
    ...
    optionalSections: ['rootx-benefits', 'rootx-gallery', 'rootx-product-showcase', 'rootx-comparison', 'rootx-trust-strip', 'rootx-final-cta'],
  ...
  luxury_editorial: {
    ...
    optionalSections: ['rootx-product-showcase', 'rootx-comparison', 'rootx-final-cta'],
  ...
  minimal_fashion: {
    ...
    requiredSections: ['rootx-hero', 'rootx-gallery'],
    optionalSections: ['rootx-product-showcase', 'rootx-benefits', 'rootx-comparison', 'rootx-final-cta'],
  ...
  warm_home: {
    ...
    requiredSections: ['rootx-hero'],
    optionalSections: ['rootx-benefits', 'rootx-gallery', 'rootx-comparison', 'rootx-trust-strip', 'rootx-final-cta'],
  ...
  bold_fitness: {
    ...
    optionalSections: ['rootx-trust-strip', 'rootx-product-showcase', 'rootx-comparison', 'rootx-gallery'],
    conditionalSections: ['rootx-specifications', 'rootx-faq'],
  ...
  high_conversion_single: {
    ...
    optionalSections: ['rootx-trust-strip', 'rootx-product-showcase', 'rootx-comparison', 'rootx-final-cta'],
    conditionalSections: ['rootx-image-story', 'rootx-specifications'],
